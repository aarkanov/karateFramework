...
## Contents
* [Setting Up Framework](#Setting-Up-Framework)
* [Running Tests](#Running-Tests)
* [Reports](#Reports)
* [Framework Utility Classes](#Framework-Utility-Classes)
    * [Auth Utility](#Auth-Utility)
    * [Command Line Utility](#Command-Line-Utility)
    * [Date Time Utility](#Date-Time-Utility)
    * [Random Generator Utility](#Random-Generator-Utility)
    * [Report Utility](#Report-Utility)
* [Karate Knowledge](#Karate-Knowledge)
    * [Syntax](#Syntax)
    ...
    * [Karate Documentation](#Karate-Documentation)
